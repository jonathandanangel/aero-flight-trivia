...
export const NPCS: Npc[] = [
  ...
  {
    id: "statue-heracles",
    name: "STATUE OF HERACLES",
    tx: 11,
    ty: 11,
    color: "#d8d0c0",
    lines: [
      "* Marble Heracles leans on his club.",
      "* The twelve labors are carved in the pedestal.",
      "* (Someone left a grapevine leaf at his feet.)",
    ],
  },
  {
    id: "statue-athena",
    ...
    color: "#e8e0d0",
    lines: [
      "* Athena of the grey eyes, shield raised.",
      "* Wisdom and war share one marble brow.",
      "* An owl is carved into the base.",
    ],
  },
  {
    id: "statue-zeus",
    ...
    color: "#d0c8b8",
    lines: [
      "* Zeus Olympios, thunderbolt half-raised.",
      "* The stone still smells faintly of ozone after rain.",
    ],
  },
  {
    id: "statue-apollo",
    name: "STATUE OF APOLLO",
    tx: 15,
    ty: 13,
    color: "#f0e8d8",
    lines: [
      "* Apollo of the lyre and the far-shot bow.",
      "* Sun-discs ring the pedestal like a calendar.",
    ],
  },
  {
    id: "statue-artemis",
    ...
    color: "#e0d8c8",
    lines: [
      "* Artemis the huntress, crescent in her hair.",
      "* A stag is carved mid-leap beneath her sandals.",
    ],
  },
  {
    id: "statue-poseidon",
    ...
    color: "#c8d0d8",
    lines: [
      "* Poseidon with trident, gazing toward the pond.",
      "* Salt crusts the marble knuckles.",
      "* (The water answers him with small waves.)",
    ],
  },
  {
    id: "statue-atreides",
    ...
    color: "#d8d0c0",
    lines: [
      "* The plaque reads: PAUL ATREIDES.",
      "* A crumpled note is wedged under the pedestal:",
...
export const ENEMIES: Record<string, Enemy> = {
  ...
  grapevine: {
    ...
    gold: 80,
    color: "#581878",
    flavor: "The FRUITFUL GRAPE VINE uncoils. Clusters of grapes sway.",
    check:
      "* FRUITFUL GRAPE VINE - ATK 9 DEF 7\n* A notch harder than LORD PETER. The scraps are the true trial.",
    mercyText: "* The vine laughs with a thousand leaves of grape.",
    mercyTurns: 5,
    attackTime: 8500,
    pattern: "vine",
    boss: true,
