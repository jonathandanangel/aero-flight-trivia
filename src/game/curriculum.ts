...
const specs: ChapterSpec[] = [
  ...
  {
    id: "impact",
    title: "K · Impact Archive",
    blurb: "Legacy Impact trivia: the 100% model and the people behind it.",
    sets: [
      ["set-i1", "The 100% model"],
      ["set-i2", "Fees and separate accounts"],
      ["set-i3", "Donors and countries"],
      ["set-i4", "The Well"],
      ["set-i5", "Operating expenses"],
      ["set-i6", "Angel investors"],
      ["set-i7", "The Pool and stewardship"],
    ],
  },
];
